...
void C3DEngine::DisplayInfo(float& fTextPosX, float& fTextPosY, float& fTextStepY, const bool bEnhanced)
{
    ...
    *szLevelName = 0;
    ...
    DrawTextRightAligned(fTextPosX, fTextPosY += fTextStepY, "CamPos=(%2d %2d %2d) %.2f %.2f %.2f Angl=%3d %2d %3d ZN=%.2f ZF=%d FC=%.2f VS=%.2f,%.2f Zoom=%.2f Speed=%1.2f TimeOfDay=%02d:%02d",
